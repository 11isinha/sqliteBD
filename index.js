...
app.post('/usuarios',(req,res)=>{
    ...
    //validação simples para garantir que nome e email foram enviados 
    if (!nome || !email){
        //se faltar algum tipo campo, retorna erro 400(Bad Request)
    ...
    db.run(sql, [nome,email], function (err){
        //se ocorrer erro pode ser emial já existe retorna erro 500
        if (err){
